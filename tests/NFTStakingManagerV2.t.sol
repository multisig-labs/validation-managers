...
contract NFTStakingManagerTest is Base {
  ...
  function setUp() public override {
    ...
    ERC1967Proxy stakingManagerProxy = new ERC1967Proxy(
      ...
      abi.encodeCall(
        ...
        _defaultNFTStakingManagerSettings(address(validatorManager), address(nft), address(hardwareNft))
      )
    );
  ...
  function _defaultNFTStakingManagerSettings(address validatorManager_, address license_, address hardwareLicense_)
    internal
    view
