...
import {ERC4626Upgradeable} from "@openzeppelin-contracts-upgradeable-5.2.0/token/ERC20/extensions/ERC4626Upgradeable.sol";
import {IERC20} from "@openzeppelin-contracts-upgradeable-5.2.0/token/ERC20/IERC20.sol";
...
contract L1ERC4626x is Initializable, ERC4626Upgradeable {
  ...
  function initialize(IERC20 _asset, uint32 _rewardsCycleLength, uint256 _initialDeposit) public initializer {
